namespace Forma_Alunos
{
	partial class Cadastro_Livro
	{
		...
		private void InitializeComponent()
		{
			...
			this.QuantidadeTextBox = new System.Windows.Forms.RichTextBox();
			...
			this.label7.Location = new System.Drawing.Point(324, 172);
			...
			this.label8.Location = new System.Drawing.Point(380, 140);
			...
			this.ISBNtextBox.Location = new System.Drawing.Point(112, 24);
			...
			this.TituloTextBox.Location = new System.Drawing.Point(112, 56);
			...
			this.EdicaoTextBox.Enabled = false;
			...
			this.EdicaoTextBox.Location = new System.Drawing.Point(492, 136);
			...
			this.EdicaoTextBox.TabIndex = 5;
			this.EdicaoTextBox.Text = "";
			this.EdicaoTextBox.KeyPress += new System.Windows.Forms.KeyPressEventHandler(this.onlyNum_KeyPress);
			// 
			// EditoraTextBox
			// 
			this.EditoraTextBox.DetectUrls = false;
			this.EditoraTextBox.Enabled = false;
			...
			this.EditoraTextBox.Location = new System.Drawing.Point(112, 136);
			...
			this.EditoraTextBox.TabIndex = 4;
			this.EditoraTextBox.Text = "";
			// 
			// AutorTextBox
			// 
			this.AutorTextBox.DetectUrls = false;
			this.AutorTextBox.Enabled = false;
			...
			this.AutorTextBox.Location = new System.Drawing.Point(112, 104);
			...
			this.AnoTextBox.Location = new System.Drawing.Point(492, 168);
			...
			this.AnoTextBox.KeyPress += new System.Windows.Forms.KeyPressEventHandler(this.onlyNum_KeyPress);
			// 
			// QuantidadeTextBox
			// 
			...
			this.QuantidadeTextBox.Multiline = false;
			this.QuantidadeTextBox.Name = "QuantidadeTextBox";
			this.QuantidadeTextBox.ShortcutsEnabled = false;
			this.QuantidadeTextBox.Size = new System.Drawing.Size(136, 27);
			this.QuantidadeTextBox.TabIndex = 1;
			this.QuantidadeTextBox.Text = "";
			this.QuantidadeTextBox.KeyPress += new System.Windows.Forms.KeyPressEventHandler(this.onlyNum_KeyPress);
			// 
			// IdiomaTextBox
			// 
			this.IdiomaTextBox.DetectUrls = false;
			this.IdiomaTextBox.Enabled = false;
			...
			this.IdiomaTextBox.Location = new System.Drawing.Point(112, 168);
			...
			this.IdiomaTextBox.TabIndex = 6;
			this.IdiomaTextBox.Text = "";
			// 
			// AssuntoTextBox
			// 
			this.AssuntoTextBox.DetectUrls = false;
			this.AssuntoTextBox.Enabled = false;
			...
			this.AssuntoTextBox.Location = new System.Drawing.Point(112, 200);
			...
			this.AssuntoTextBox.Enter += new System.EventHandler(this.AssuntoTextBox_Enter);
			this.AssuntoTextBox.Leave += new System.EventHandler(this.AssuntoTextBox_Leave);
			// 
			// label9
			// 
			...
			this.DescricaoTextBox.Location = new System.Drawing.Point(112, 232);
			...
			this.BotaoCadastrar.Location = new System.Drawing.Point(112, 296);
		...
		private System.Windows.Forms.RichTextBox QuantidadeTextBox;
